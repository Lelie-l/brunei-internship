        ...
        <div className='MainContainer-Test'>
            <div className='Row'>
                ...
                <div className='Section1'>
                    <img className='img-test' src="https://mosqpedia.org/img/cache/largeimage/2VO6yirFEZaug1hwypPw4eNwcK5rpktP6XQK3NyT" alt="pic" width="100%"></img>
                    <div className='desc-test'>Religious Sites</div>
                </div>
                <div className='Section1'>
                    <img className='img-test' src="https://images.squarespace-cdn.com/content/v1/5e72c8bfe21ad940ba788673/1621088501890-G9PLJ8QNZCSX4JSVTK4D/kampong-ayer-top-image.jpg" alt="pic" width="100%"></img>
